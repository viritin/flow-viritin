 ...
 */
@Tag(Tag.DIV)
public class GenericDiv extends HtmlContainer implements ClickNotifier<GenericDiv> {
    // TODO the Div implementation has no generic implementation of ClickNotifier
