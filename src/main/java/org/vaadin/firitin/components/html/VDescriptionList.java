...
public class VDescriptionList extends DescriptionList implements FluentHtmlContainer<VDescriptionList>, FluentClickNotifier<DescriptionList, VDescriptionList> {
