...
public class VListBox<T> extends ListBox<T> implements FluentComponent<VListBox<T>>, FluentHasStyle<VListBox<T>>, FluentHasDataProvider<VListBox<T>, T>,
        FluentHasSize<VListBox<T>>, FluentHasItems<VListBox<T>, T>, FluentFocusable<ListBox<T>, VListBox<T>>, FluentHasValueAndElement<VListBox<T>, AbstractField.ComponentValueChangeEvent<ListBox<T>, T>, T> {
