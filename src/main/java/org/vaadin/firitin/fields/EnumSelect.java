...
public class EnumSelect<T extends Enum> extends ComboBox<T> implements FluentHasSize<EnumSelect<T>>,
    FluentHasValidation<EnumSelect<T>>, FluentHasItems<EnumSelect<T>, T>, FluentFocusable<ComboBox<T>, EnumSelect<T>>,
