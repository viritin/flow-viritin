 ...
 */
@Route
public class UploadFileHandleFolderDD extends VerticalLayout {

    private static final String DELIMITER = ";";

    public UploadFileHandleFolderDD() {
        ...
        UploadFileHandler multiUploadFileHandler = new UploadFileHandler( (content, metadata) ->{
                    try {
                        ...
                        Logger.getLogger(UploadFileHandleFolderDD.class.getName()).log(Level.SEVERE, null, ex);
