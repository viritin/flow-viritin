...
import org.vaadin.firitin.components.DurationField;
...
public class FormFieldsView extends BeanValidationForm<FormFieldsView.MyRecord> {
    ...
    public record MyRecord(MyEnum myEnum, Duration duration, List<Element> children) {
    }
    ...
    public FormFieldsView() {
        ...
        setEntity(new MyRecord(MyEnum.ONE, Duration.ofHours(1).plusSeconds(30), new ArrayList<>()));
    ...
    protected List<Component> getFormComponents() {
        return Arrays.asList(duration, myEnum, children);
    }
    ...
    protected Component createContent() {
        ...
        layout.addComponentAsFirst(new RichText().withMarkDown("""
                        ...
                        This view shows various generic form fields and their usage. 
